...
//sampler sampler intensityTextureSmpSC 2:10
//sampler sampler sc_OITCommonSampler 2:11
//sampler sampler scrTexSmpSC 2:12
//texture texture2D intensityTexture 2:0:2:10
//texture texture2D sc_OITAlpha0 2:1:2:11
//texture texture2D sc_OITAlpha1 2:2:2:11
//texture texture2D sc_OITDepthHigh0 2:3:2:11
//texture texture2D sc_OITDepthHigh1 2:4:2:11
//texture texture2D sc_OITDepthLow0 2:5:2:11
//texture texture2D sc_OITDepthLow1 2:6:2:11
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:7:2:11
//texture texture2D sc_OITFrontDepthTexture 2:8:2:11
//texture texture2D scrTex 2:9:2:12
//SG_REFLECTION_END
...
uniform vec4 scrTexSize;
uniform vec4 scrTexView;
uniform mat3 scrTexTransform;
uniform vec4 scrTexUvMinMax;
uniform vec4 scrTexBorderColor;
uniform float baseColorA;
...
#endif
#ifndef scrTexHasSwappedViews
#define scrTexHasSwappedViews 0
#elif scrTexHasSwappedViews==1
#undef scrTexHasSwappedViews
#define scrTexHasSwappedViews 1
#endif
#ifndef scrTexLayout
#define scrTexLayout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_scrTex
#define SC_USE_UV_TRANSFORM_scrTex 0
#elif SC_USE_UV_TRANSFORM_scrTex==1
#undef SC_USE_UV_TRANSFORM_scrTex
#define SC_USE_UV_TRANSFORM_scrTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_scrTex
#define SC_SOFTWARE_WRAP_MODE_U_scrTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_scrTex
#define SC_SOFTWARE_WRAP_MODE_V_scrTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_scrTex
#define SC_USE_UV_MIN_MAX_scrTex 0
#elif SC_USE_UV_MIN_MAX_scrTex==1
#undef SC_USE_UV_MIN_MAX_scrTex
#define SC_USE_UV_MIN_MAX_scrTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_scrTex
#define SC_USE_CLAMP_TO_BORDER_scrTex 0
#elif SC_USE_CLAMP_TO_BORDER_scrTex==1
#undef SC_USE_CLAMP_TO_BORDER_scrTex
#define SC_USE_CLAMP_TO_BORDER_scrTex 1
#endif
uniform vec4 intensityTextureDims;
uniform float correctedIntensity;
uniform mat3 intensityTextureTransform;
...
uniform float reflBlurMaxRough;
uniform vec4 scrTexView;
uniform mediump sampler2D scrTex;
...
vec2 l9_1[8];
l9_1[0]=vec2(1.0162,0.4209);
l9_1[1]=vec2(0.4209,1.0162);
l9_1[2]=vec2(-0.4209,1.0162);
l9_1[3]=vec2(-1.0162,0.4209);
l9_1[4]=vec2(-1.0162,-0.4209);
l9_1[5]=vec2(-0.4209,-1.0162);
l9_1[6]=vec2(0.4209,-1.0162);
l9_1[7]=vec2(1.0162,-0.4209);
vec2 l9_2=l9_1[int(clamp(Globals.Loop_Index_ID0+0.0001,0.0,7.0))];
int l9_3;
#if (scrTexHasSwappedViews)
{
...
#endif
Output+=sc_SampleTextureBiasOrLevel(scrTexDims.xy,scrTexLayout,l9_3,l9_0+((scrTexSize.zw*vec2(12.996))*l9_2),(int(SC_USE_UV_TRANSFORM_scrTex)!=0),scrTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_scrTex,SC_SOFTWARE_WRAP_MODE_V_scrTex),(int(SC_USE_UV_MIN_MAX_scrTex)!=0),scrTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_scrTex)!=0),scrTexBorderColor,4.4,scrTex);
}
...
#endif
vec4 l9_5=sc_SampleTextureBiasOrLevel(scrTexDims.xy,scrTexLayout,l9_4,l9_3,(int(SC_USE_UV_TRANSFORM_scrTex)!=0),scrTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_scrTex,SC_SOFTWARE_WRAP_MODE_V_scrTex),(int(SC_USE_UV_MIN_MAX_scrTex)!=0),scrTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_scrTex)!=0),scrTexBorderColor,0.0,scrTex);
int l9_6;
#if (scrTexHasSwappedViews)
{
...
#endif
vec4 l9_7=vec4(0.0);
ssGlobals l9_8=ssGlobals(l9_1,l9_2,0.0,l9_3,0.0,0.0,8.0);
LoopFunction_N104(0.0,0.0,l9_7,l9_8);
LoopFunction_N104(1.0,0.142857,l9_7,l9_8);
LoopFunction_N104(2.0,0.285714,l9_7,l9_8);
LoopFunction_N104(3.0,0.428571,l9_7,l9_8);
LoopFunction_N104(4.0,0.571429,l9_7,l9_8);
LoopFunction_N104(5.0,0.714286,l9_7,l9_8);
LoopFunction_N104(6.0,0.857143,l9_7,l9_8);
LoopFunction_N104(7.0,1.0,l9_7,l9_8);
vec3 l9_15=l9_5.xyz;
vec3 l9_16=mix(sc_SampleTextureBiasOrLevel(scrTexDims.xy,scrTexLayout,l9_6,l9_3,(int(SC_USE_UV_TRANSFORM_scrTex)!=0),scrTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_scrTex,SC_SOFTWARE_WRAP_MODE_V_scrTex),(int(SC_USE_UV_MIN_MAX_scrTex)!=0),scrTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_scrTex)!=0),scrTexBorderColor,4.4,scrTex),l9_7*vec4(0.125),vec4(0.84)).xyz-l9_15;
float l9_17=clamp(0.501-dot(l9_16,vec3(0.0,1.0,1.0)),0.001,1.001);
float l9_18=l9_17-0.001;
vec2 l9_19=vec2(0.0);
l9_19.x=l9_18;
vec2 l9_20=l9_19;
l9_20.y=1.001-l9_17;
vec2 l9_21=l9_20*l9_20;
vec2 l9_22=l9_21*l9_21;
vec2 l9_23=(l9_22*l9_22)*vec2(128.0);
vec3 l9_24=(vec3(mix(1.0-l9_23.y,l9_23.x,step(l9_18,0.5)))*vec3(0.3917,-0.4554,0.0637))+vec3(-0.3917,1.4554,-0.0637);
vec3 l9_25=mix(l9_15,(l9_16*vec3((-0.05)*step(0.01,dot(l9_16,l9_16))))+((l9_15*((l9_15*vec3(l9_24.x))+vec3(l9_24.y)))+vec3(l9_24.z)),vec3(baseColorA));
...
{
if (1.0<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_27=ngsPixelShader(l9_26);
vec4 l9_28=max(l9_27,vec4(0.0));
...
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
l9_30=varViewSpaceDepth;
}
#else
{
l9_30=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].z/(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][2].z+((sc_GetGlFragCoord().z*2.0)-1.0));
}
#endif
float l9_31=clamp(l9_30*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_31),min(1.0,l9_31+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITFrontLayerPass)
{
vec4 l9_32=texture2D(sc_OITFrontDepthTexture,getScreenUV());
float l9_33;
#if (sc_SkinBonesCount>0)
{
l9_33=5e-07;
...
#endif
if (abs(sc_GetGlFragCoord().z-l9_32.x)>l9_33)
{
discard;
}
