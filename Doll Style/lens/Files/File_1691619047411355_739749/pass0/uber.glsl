...
//sampler sampler gaussTextureSmpSC 2:11
//sampler sampler inputTextureSmpSC 2:12
//sampler sampler intensityTextureSmpSC 2:13
//sampler sampler sc_OITCommonSampler 2:14
//texture texture2D gaussTexture 2:0:2:11
//texture texture2D inputTexture 2:1:2:12
...
uniform vec4 gaussTextureSize;
uniform vec4 gaussTextureView;
uniform mat3 gaussTextureTransform;
uniform vec4 gaussTextureUvMinMax;
uniform vec4 gaussTextureBorderColor;
uniform float alpha;
...
#endif
#ifndef gaussTextureHasSwappedViews
#define gaussTextureHasSwappedViews 0
#elif gaussTextureHasSwappedViews==1
#undef gaussTextureHasSwappedViews
#define gaussTextureHasSwappedViews 1
#endif
#ifndef gaussTextureLayout
#define gaussTextureLayout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_gaussTexture
#define SC_USE_UV_TRANSFORM_gaussTexture 0
#elif SC_USE_UV_TRANSFORM_gaussTexture==1
#undef SC_USE_UV_TRANSFORM_gaussTexture
#define SC_USE_UV_TRANSFORM_gaussTexture 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_gaussTexture
#define SC_SOFTWARE_WRAP_MODE_U_gaussTexture -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_gaussTexture
#define SC_SOFTWARE_WRAP_MODE_V_gaussTexture -1
#endif
#ifndef SC_USE_UV_MIN_MAX_gaussTexture
#define SC_USE_UV_MIN_MAX_gaussTexture 0
#elif SC_USE_UV_MIN_MAX_gaussTexture==1
#undef SC_USE_UV_MIN_MAX_gaussTexture
#define SC_USE_UV_MIN_MAX_gaussTexture 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_gaussTexture
#define SC_USE_CLAMP_TO_BORDER_gaussTexture 0
#elif SC_USE_CLAMP_TO_BORDER_gaussTexture==1
#undef SC_USE_CLAMP_TO_BORDER_gaussTexture
#define SC_USE_CLAMP_TO_BORDER_gaussTexture 1
#endif
uniform vec4 intensityTextureDims;
uniform float correctedIntensity;
uniform mat3 intensityTextureTransform;
...
uniform mediump sampler2D gaussTexture;
...
vec3 l9_3=l9_2.xyz;
int l9_4;
#if (gaussTextureHasSwappedViews)
{
...
#endif
vec4 l9_5=sc_SampleTextureBiasOrLevel(gaussTextureDims.xy,gaussTextureLayout,l9_4,l9_0,(int(SC_USE_UV_TRANSFORM_gaussTexture)!=0),gaussTextureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_gaussTexture,SC_SOFTWARE_WRAP_MODE_V_gaussTexture),(int(SC_USE_UV_MIN_MAX_gaussTexture)!=0),gaussTextureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_gaussTexture)!=0),gaussTextureBorderColor,0.0,gaussTexture);
vec3 l9_6=l9_5.xyz-l9_3;
float l9_7=clamp((length(l9_2.yz)-length(l9_5.yz))+0.5,0.0,1.0);
vec2 l9_8=vec2(l9_7,1.0-l9_7);
vec2 l9_9=l9_8*l9_8;
vec2 l9_10=l9_9*l9_9;
vec2 l9_11=(l9_10*l9_10)*128.0;
...
#endif
vec4 l9_12=ngsPixelShader(vec4(mix(l9_3,mix(clamp((((l9_3*(-0.391731))*l9_3)+(l9_3*1.4554))-vec3(0.0637),vec3(0.0),vec3(1.0)),l9_3,vec3(mix(1.0-l9_11.y,l9_11.x,step(l9_7,0.5))))+(l9_6*(step(0.01,dot(l9_6,l9_6))*0.05)),vec3(alpha)),1.0));
