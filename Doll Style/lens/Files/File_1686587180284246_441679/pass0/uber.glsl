...
{
if (l9_2<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
l9_11=varViewSpaceDepth;
}
#else
{
l9_11=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].z/(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][2].z+((sc_GetGlFragCoord().z*2.0)-1.0));
}
#endif
float l9_12=clamp(l9_11*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_12),min(1.0,l9_12+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITFrontLayerPass)
{
vec4 l9_13=texture2D(sc_OITFrontDepthTexture,getScreenUV());
float l9_14;
#if (sc_SkinBonesCount>0)
{
l9_14=5e-07;
...
#endif
if (abs(sc_GetGlFragCoord().z-l9_13.x)>l9_14)
{
discard;
}
