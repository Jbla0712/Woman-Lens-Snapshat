...
//sampler sampler Tweak_N26SmpSC 2:13
//sampler sampler Tweak_N35SmpSC 2:14
//sampler sampler intensityTextureSmpSC 2:15
//sampler sampler loop_bufferSmpSC 2:16
//sampler sampler loop_inputSmpSC 2:17
//sampler sampler sc_OITCommonSampler 2:18
//texture texture2D Tweak_N26 2:0:2:13
//texture texture2D Tweak_N35 2:1:2:14
//texture texture2D intensityTexture 2:2:2:15
//texture texture2D loop_buffer 2:3:2:16
//texture texture2D loop_input 2:4:2:17
//texture texture2D sc_OITAlpha0 2:5:2:18
//texture texture2D sc_OITAlpha1 2:6:2:18
//texture texture2D sc_OITDepthHigh0 2:7:2:18
//texture texture2D sc_OITDepthHigh1 2:8:2:18
//texture texture2D sc_OITDepthLow0 2:9:2:18
//texture texture2D sc_OITDepthLow1 2:10:2:18
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:11:2:18
//texture texture2D sc_OITFrontDepthTexture 2:12:2:18
//SG_REFLECTION_END
...
uniform vec4 loop_inputDims;
uniform vec4 loop_bufferDims;
uniform vec4 Tweak_N35Dims;
uniform vec4 Tweak_N26Dims;
...
uniform vec4 loop_inputSize;
uniform vec4 loop_inputView;
uniform mat3 loop_inputTransform;
uniform vec4 loop_inputUvMinMax;
uniform vec4 loop_inputBorderColor;
uniform vec4 loop_bufferSize;
uniform vec4 loop_bufferView;
uniform mat3 loop_bufferTransform;
uniform vec4 loop_bufferUvMinMax;
uniform vec4 loop_bufferBorderColor;
uniform float transition;
uniform float from_center_force;
uniform vec4 Tweak_N35Size;
uniform vec4 Tweak_N35View;
uniform mat3 Tweak_N35Transform;
uniform vec4 Tweak_N35UvMinMax;
uniform vec4 Tweak_N35BorderColor;
uniform float curl_noise_strength;
uniform vec4 Tweak_N26Size;
uniform vec4 Tweak_N26View;
uniform mat3 Tweak_N26Transform;
uniform vec4 Tweak_N26UvMinMax;
uniform vec4 Tweak_N26BorderColor;
...
#endif
#ifndef loop_inputHasSwappedViews
#define loop_inputHasSwappedViews 0
#elif loop_inputHasSwappedViews==1
#undef loop_inputHasSwappedViews
#define loop_inputHasSwappedViews 1
#endif
#ifndef loop_inputLayout
#define loop_inputLayout 0
#endif
#ifndef loop_bufferHasSwappedViews
#define loop_bufferHasSwappedViews 0
#elif loop_bufferHasSwappedViews==1
#undef loop_bufferHasSwappedViews
#define loop_bufferHasSwappedViews 1
#endif
#ifndef loop_bufferLayout
#define loop_bufferLayout 0
#endif
#ifndef Tweak_N35HasSwappedViews
#define Tweak_N35HasSwappedViews 0
#elif Tweak_N35HasSwappedViews==1
#undef Tweak_N35HasSwappedViews
#define Tweak_N35HasSwappedViews 1
#endif
#ifndef Tweak_N35Layout
#define Tweak_N35Layout 0
#endif
#ifndef Tweak_N26HasSwappedViews
#define Tweak_N26HasSwappedViews 0
#elif Tweak_N26HasSwappedViews==1
#undef Tweak_N26HasSwappedViews
#define Tweak_N26HasSwappedViews 1
#endif
#ifndef Tweak_N26Layout
#define Tweak_N26Layout 0
#endif
#ifndef SC_USE_UV_TRANSFORM_loop_input
#define SC_USE_UV_TRANSFORM_loop_input 0
#elif SC_USE_UV_TRANSFORM_loop_input==1
#undef SC_USE_UV_TRANSFORM_loop_input
#define SC_USE_UV_TRANSFORM_loop_input 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_loop_input
#define SC_SOFTWARE_WRAP_MODE_U_loop_input -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_loop_input
#define SC_SOFTWARE_WRAP_MODE_V_loop_input -1
#endif
#ifndef SC_USE_UV_MIN_MAX_loop_input
#define SC_USE_UV_MIN_MAX_loop_input 0
#elif SC_USE_UV_MIN_MAX_loop_input==1
#undef SC_USE_UV_MIN_MAX_loop_input
#define SC_USE_UV_MIN_MAX_loop_input 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_loop_input
#define SC_USE_CLAMP_TO_BORDER_loop_input 0
#elif SC_USE_CLAMP_TO_BORDER_loop_input==1
#undef SC_USE_CLAMP_TO_BORDER_loop_input
#define SC_USE_CLAMP_TO_BORDER_loop_input 1
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N35
#define SC_USE_UV_TRANSFORM_Tweak_N35 0
#elif SC_USE_UV_TRANSFORM_Tweak_N35==1
#undef SC_USE_UV_TRANSFORM_Tweak_N35
#define SC_USE_UV_TRANSFORM_Tweak_N35 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N35
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N35 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N35
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N35 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N35
#define SC_USE_UV_MIN_MAX_Tweak_N35 0
#elif SC_USE_UV_MIN_MAX_Tweak_N35==1
#undef SC_USE_UV_MIN_MAX_Tweak_N35
#define SC_USE_UV_MIN_MAX_Tweak_N35 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N35
#define SC_USE_CLAMP_TO_BORDER_Tweak_N35 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N35==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N35
#define SC_USE_CLAMP_TO_BORDER_Tweak_N35 1
#endif
#ifndef SC_USE_UV_TRANSFORM_loop_buffer
#define SC_USE_UV_TRANSFORM_loop_buffer 0
#elif SC_USE_UV_TRANSFORM_loop_buffer==1
#undef SC_USE_UV_TRANSFORM_loop_buffer
#define SC_USE_UV_TRANSFORM_loop_buffer 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_loop_buffer
#define SC_SOFTWARE_WRAP_MODE_U_loop_buffer -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_loop_buffer
#define SC_SOFTWARE_WRAP_MODE_V_loop_buffer -1
#endif
#ifndef SC_USE_UV_MIN_MAX_loop_buffer
#define SC_USE_UV_MIN_MAX_loop_buffer 0
#elif SC_USE_UV_MIN_MAX_loop_buffer==1
#undef SC_USE_UV_MIN_MAX_loop_buffer
#define SC_USE_UV_MIN_MAX_loop_buffer 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_loop_buffer
#define SC_USE_CLAMP_TO_BORDER_loop_buffer 0
#elif SC_USE_CLAMP_TO_BORDER_loop_buffer==1
#undef SC_USE_CLAMP_TO_BORDER_loop_buffer
#define SC_USE_CLAMP_TO_BORDER_loop_buffer 1
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N26
#define SC_USE_UV_TRANSFORM_Tweak_N26 0
#elif SC_USE_UV_TRANSFORM_Tweak_N26==1
#undef SC_USE_UV_TRANSFORM_Tweak_N26
#define SC_USE_UV_TRANSFORM_Tweak_N26 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N26
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N26 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N26
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N26 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N26
#define SC_USE_UV_MIN_MAX_Tweak_N26 0
#elif SC_USE_UV_MIN_MAX_Tweak_N26==1
#undef SC_USE_UV_MIN_MAX_Tweak_N26
#define SC_USE_UV_MIN_MAX_Tweak_N26 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N26
#define SC_USE_CLAMP_TO_BORDER_Tweak_N26 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N26==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N26
#define SC_USE_CLAMP_TO_BORDER_Tweak_N26 1
#endif
uniform vec4 intensityTextureDims;
uniform float correctedIntensity;
uniform mat3 intensityTextureTransform;
...
uniform vec4 Tweak_N26Size;
uniform vec4 Tweak_N26View;
uniform mediump sampler2D loop_input;
uniform mediump sampler2D Tweak_N35;
uniform mediump sampler2D loop_buffer;
uniform mediump sampler2D Tweak_N26;
...
vec2 l9_1=getScreenUV();
int l9_2;
#if (loop_inputHasSwappedViews)
{
...
#endif
vec4 l9_3=sc_SampleTextureBiasOrLevel(loop_inputDims.xy,loop_inputLayout,l9_2,l9_1,(int(SC_USE_UV_TRANSFORM_loop_input)!=0),loop_inputTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_loop_input,SC_SOFTWARE_WRAP_MODE_V_loop_input),(int(SC_USE_UV_MIN_MAX_loop_input)!=0),loop_inputUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_loop_input)!=0),loop_inputBorderColor,0.0,loop_input);
float l9_4=clamp(transition+0.001,0.001,1.001);
float l9_5=1.001-l9_4;
float l9_6;
if (l9_5<=0.0)
{
l9_6=0.0;
...
float l9_7=l9_6*2.0;
float l9_8=clamp(l9_7+1.0,1.0,3.0);
int l9_9;
#if (Tweak_N35HasSwappedViews)
{
...
#endif
vec4 l9_10=sc_SampleTextureBiasOrLevel(Tweak_N35Dims.xy,Tweak_N35Layout,l9_9,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_Tweak_N35)!=0),Tweak_N35Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N35,SC_SOFTWARE_WRAP_MODE_V_Tweak_N35),(int(SC_USE_UV_MIN_MAX_Tweak_N35)!=0),Tweak_N35UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N35)!=0),Tweak_N35BorderColor,0.0,Tweak_N35);
int l9_11;
#if (loop_bufferHasSwappedViews)
{
...
#endif
vec4 l9_12=sc_SampleTextureBiasOrLevel(loop_bufferDims.xy,loop_bufferLayout,l9_11,(l9_1+((((vec2(0.5)-l9_1)*vec2(l9_8))*vec2(from_center_force))*vec2(0.01)))+((((vec2(l9_10.xy)*vec2(2.0))+vec2(-1.0))*vec2(0.01))*vec2(l9_8*curl_noise_strength)),(int(SC_USE_UV_TRANSFORM_loop_buffer)!=0),loop_bufferTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_loop_buffer,SC_SOFTWARE_WRAP_MODE_V_loop_buffer),(int(SC_USE_UV_MIN_MAX_loop_buffer)!=0),loop_bufferUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_loop_buffer)!=0),loop_bufferBorderColor,0.0,loop_buffer);
vec2 l9_13=vec2(l9_0);
int l9_14;
#if (Tweak_N26HasSwappedViews)
{
...
#endif
vec4 l9_15=sc_SampleTextureBiasOrLevel(Tweak_N26Dims.xy,Tweak_N26Layout,l9_14,(varPackedTex.xy+l9_13)*vec2(2.0,3.0),(int(SC_USE_UV_TRANSFORM_Tweak_N26)!=0),Tweak_N26Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N26,SC_SOFTWARE_WRAP_MODE_V_Tweak_N26),(int(SC_USE_UV_MIN_MAX_Tweak_N26)!=0),Tweak_N26UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N26)!=0),Tweak_N26BorderColor,0.0,Tweak_N26);
vec4 l9_16=mix(l9_3,l9_12*vec4(1.0-step(l9_15.x,0.3)),vec4(float((l9_4-0.001)>0.0)));
float l9_17=l9_16.w;
...
{
if (l9_17<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_18=ngsPixelShader(l9_16);
vec4 l9_19=max(l9_18,vec4(0.0));
sc_writeFragData0(l9_19);
vec4 l9_20=clamp(l9_19,vec4(0.0),vec4(1.0));
...
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
l9_21=varViewSpaceDepth;
}
#else
{
l9_21=sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][3].z/(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()][2].z+((sc_GetGlFragCoord().z*2.0)-1.0));
}
#endif
float l9_22=clamp(l9_21*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_22),min(1.0,l9_22+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
oitDepthGather(l9_20);
}
#else
{
#if (sc_OITCompositingPass)
{
oitCompositing(l9_20);
}
#else
{
...
#if (sc_OITFrontLayerPass)
{
vec4 l9_23=texture2D(sc_OITFrontDepthTexture,getScreenUV());
float l9_24;
#if (sc_SkinBonesCount>0)
{
l9_24=5e-07;
...
#endif
if (abs(sc_GetGlFragCoord().z-l9_23.x)>l9_24)
{
discard;
}
sc_writeFragData0(l9_20);
}
#endif
}
#else
