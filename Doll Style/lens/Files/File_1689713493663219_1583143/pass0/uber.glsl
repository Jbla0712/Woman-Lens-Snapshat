...
//sampler sampler Tweak_N8SmpSC 2:11
//sampler sampler intensityTextureSmpSC 2:12
//sampler sampler sc_OITCommonSampler 2:13
//sampler sampler screen_textureSmpSC 2:14
//texture texture2D Tweak_N8 2:0:2:11
//texture texture2D intensityTexture 2:1:2:12
//texture texture2D sc_OITAlpha0 2:2:2:13
//texture texture2D sc_OITAlpha1 2:3:2:13
//texture texture2D sc_OITDepthHigh0 2:4:2:13
//texture texture2D sc_OITDepthHigh1 2:5:2:13
//texture texture2D sc_OITDepthLow0 2:6:2:13
//texture texture2D sc_OITDepthLow1 2:7:2:13
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:8:2:13
//texture texture2D sc_OITFrontDepthTexture 2:9:2:13
//texture texture2D screen_texture 2:10:2:14
//SG_REFLECTION_END
...
uniform vec4 screen_textureDims;
...
uniform vec4 screen_textureSize;
uniform vec4 screen_textureView;
uniform mat3 screen_textureTransform;
uniform vec4 screen_textureUvMinMax;
uniform vec4 screen_textureBorderColor;
...
#endif
#ifndef screen_textureHasSwappedViews
#define screen_textureHasSwappedViews 0
#elif screen_textureHasSwappedViews==1
#undef screen_textureHasSwappedViews
#define screen_textureHasSwappedViews 1
#endif
#ifndef screen_textureLayout
#define screen_textureLayout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_screen_texture
#define SC_USE_UV_TRANSFORM_screen_texture 0
#elif SC_USE_UV_TRANSFORM_screen_texture==1
#undef SC_USE_UV_TRANSFORM_screen_texture
#define SC_USE_UV_TRANSFORM_screen_texture 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_screen_texture
#define SC_SOFTWARE_WRAP_MODE_U_screen_texture -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_screen_texture
#define SC_SOFTWARE_WRAP_MODE_V_screen_texture -1
#endif
#ifndef SC_USE_UV_MIN_MAX_screen_texture
#define SC_USE_UV_MIN_MAX_screen_texture 0
#elif SC_USE_UV_MIN_MAX_screen_texture==1
#undef SC_USE_UV_MIN_MAX_screen_texture
#define SC_USE_UV_MIN_MAX_screen_texture 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_screen_texture
#define SC_USE_CLAMP_TO_BORDER_screen_texture 0
#elif SC_USE_CLAMP_TO_BORDER_screen_texture==1
#undef SC_USE_CLAMP_TO_BORDER_screen_texture
#define SC_USE_CLAMP_TO_BORDER_screen_texture 1
#endif
...
uniform vec4 Tweak_N8Size;
uniform vec4 Tweak_N8View;
uniform mediump sampler2D screen_texture;
uniform mediump sampler2D Tweak_N8;
...
vec2 l9_0=getScreenUV();
int l9_1;
#if (screen_textureHasSwappedViews)
{
...
#endif
vec4 l9_2=sc_SampleTextureBiasOrLevel(screen_textureDims.xy,screen_textureLayout,l9_1,l9_0,(int(SC_USE_UV_TRANSFORM_screen_texture)!=0),screen_textureTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_screen_texture,SC_SOFTWARE_WRAP_MODE_V_screen_texture),(int(SC_USE_UV_MIN_MAX_screen_texture)!=0),screen_textureUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_screen_texture)!=0),screen_textureBorderColor,0.0,screen_texture);
int l9_3;
...
#endif
vec4 l9_4=sc_SampleTextureBiasOrLevel(Tweak_N8Dims.xy,Tweak_N8Layout,l9_3,l9_0,(int(SC_USE_UV_TRANSFORM_Tweak_N8)!=0),Tweak_N8Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8),(int(SC_USE_UV_MIN_MAX_Tweak_N8)!=0),Tweak_N8UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0),Tweak_N8BorderColor,0.0,Tweak_N8);
float l9_5;
if (float(transition>0.0)!=0.0)
{
l9_5=(smoothstep(0.3,0.0,transition)*Tweak_N5)+1.0;
}
else
{
l9_5=1.0;
}
vec4 l9_6=l9_4*vec4(l9_5);
vec3 l9_7=mix(l9_2.xyz,l9_6.xyz,vec3(l9_6.w));
float l9_8=l9_2.w;
...
{
if (l9_8<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_10=ngsPixelShader(l9_9);
