...
#endif
const ivec2 g9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture);
...
if (l9_0.x<l9_1.x)
{
l9_2=vec4(l9_1.xy,g9_63,l9_0.x);
}
else
{
l9_2=vec4(l9_0.x,l9_1.y,g9_63,l9_1.x);
}
...
if (l9_44.x<l9_46.x)
{
l9_47=vec4(l9_46.xy,g9_63,l9_44.x);
}
else
{
l9_47=vec4(l9_44.x,l9_46.y,g9_63,l9_46.x);
}
...
if (l9_55.x<l9_60.x)
{
l9_61=vec4(l9_60.xy,g9_63,l9_55.x);
}
else
{
l9_61=vec4(l9_55.x,l9_60.y,g9_63,l9_60.x);
}
...
if (l9_64.x<l9_69.x)
{
l9_70=vec4(l9_69.xy,g9_63,l9_64.x);
}
else
{
l9_70=vec4(l9_64.x,l9_69.y,g9_63,l9_69.x);
}
...
if (l9_74.x<l9_78.x)
{
l9_79=vec4(l9_78.xy,g9_63,l9_74.x);
}
else
{
l9_79=vec4(l9_74.x,l9_78.y,g9_63,l9_78.x);
}
...
vec4 l9_4=vec4(l9_3.x,l9_3.y,l9_3.z,g9_62.w);
l9_4.w=1.0;
result=l9_4;
}
#else
...
#endif
vec4 param=l9_0;
vec4 l9_1=ngsPixelShader(param);
...
#if (sc_OITDepthBoundsPass)
{
float l9_4=clamp(viewSpaceDepth()*0.001,0.0,1.0);
vec4 l9_5=vec4(max(0.0,1.00392-l9_4),min(1.0,l9_4+0.00392157),0.0,0.0);
