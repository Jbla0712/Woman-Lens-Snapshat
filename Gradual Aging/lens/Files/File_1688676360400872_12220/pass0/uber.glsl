...
//sampler sampler baseTexSmpSC 2:10
//sampler sampler intensityTextureSmpSC 2:11
//sampler sampler sc_OITCommonSampler 2:12
//SG_REFLECTION_END
...
//sampler sampler intensityTextureSmpSC 2:11
//sampler sampler sc_OITCommonSampler 2:12
//texture texture2D baseTex 2:0:2:10
//texture texture2D intensityTexture 2:1:2:11
//texture texture2D sc_OITAlpha0 2:2:2:12
//texture texture2D sc_OITAlpha1 2:3:2:12
//texture texture2D sc_OITDepthHigh0 2:4:2:12
//texture texture2D sc_OITDepthHigh1 2:5:2:12
//texture texture2D sc_OITDepthLow0 2:6:2:12
//texture texture2D sc_OITDepthLow1 2:7:2:12
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:8:2:12
//texture texture2D sc_OITFrontDepthTexture 2:9:2:12
//SG_REFLECTION_END
...
vec2 param=baseTexDims.xy;
int param_1=baseTexLayout;
int param_2=baseTexGetStereoViewIndex();
vec2 param_3=varPackedTex.xy;
bool param_4=(int(SC_USE_UV_TRANSFORM_baseTex)!=0);
mat3 param_5=baseTexTransform;
ivec2 param_6=g9_55;
bool param_7=(int(SC_USE_UV_MIN_MAX_baseTex)!=0);
vec4 param_8=baseTexUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
vec4 param_10=baseTexBorderColor;
float param_11=0.0;
vec4 l9_0=sc_SampleTextureBiasOrLevel(param,param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9,param_10,param_11,baseTex);
vec3 l9_1=mix(l9_0.xyz,vec3(0.0),vec3(0.390005));
vec4 l9_2=vec4(l9_1.x,l9_1.y,l9_1.z,g9_62.w);
l9_2.w=l9_0.w;
...
{
if (l9_0.w<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 param_12=l9_2;
vec4 l9_3=ngsPixelShader(param_12);
vec4 l9_4=max(l9_3,vec4(0.0));
vec4 param_13=l9_4;
sc_writeFragData0(param_13);
vec4 l9_5=clamp(l9_4,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_6=clamp(viewSpaceDepth()*0.001,0.0,1.0);
vec4 l9_7=vec4(max(0.0,1.00392-l9_6),min(1.0,l9_6+0.00392157),0.0,0.0);
