...
//sampler sampler alphaTexSmpSC 2:16
...
//sampler sampler texWarpOutSmpSC 2:23
...
#endif
const ivec2 g9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_intensityTexture,SC_SOFTWARE_WRAP_MODE_V_intensityTexture);
...
#endif
const ivec2 g9_59=ivec2(SC_SOFTWARE_WRAP_MODE_U_texWarp,SC_SOFTWARE_WRAP_MODE_V_texWarp);
...
#endif
const ivec2 g9_60=ivec2(SC_SOFTWARE_WRAP_MODE_U_inputTex,SC_SOFTWARE_WRAP_MODE_V_inputTex);
...
#endif
const ivec2 g9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_colorTex,SC_SOFTWARE_WRAP_MODE_V_colorTex);
...
#endif
const ivec2 g9_62=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTex,SC_SOFTWARE_WRAP_MODE_V_screenTex);
...
#endif
const ivec2 g9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex);
...
int colorTexGetStereoViewIndex()
{
...
void Node94_If_else(float Bool1,vec3 Value1,inout vec3 Default,out vec3 Result,ssGlobals Globals)
{
vec2 param=texWarpDims.xy;
int param_1=texWarpLayout;
int param_2=texWarpGetStereoViewIndex();
vec2 param_3=Globals.Surface_UVCoord0;
bool param_4=(int(SC_USE_UV_TRANSFORM_texWarp)!=0);
mat3 param_5=texWarpTransform;
ivec2 param_6=g9_59;
bool param_7=(int(SC_USE_UV_MIN_MAX_texWarp)!=0);
vec4 param_8=texWarpUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_texWarp)!=0);
vec4 param_10=texWarpBorderColor;
float param_11=0.0;
vec4 l9_0=sc_SampleTextureBiasOrLevel(param,param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9,param_10,param_11,texWarp);
vec4 l9_1=((l9_0*(warpMax-warpMin))+warpMin)*vec4(1.0,-1.0,1.0,1.0);
vec4 l9_2=vec4(l9_1.x,l9_1.y,vec4(0.0).z,vec4(0.0).w);
l9_2.z=0.0;
vec4 l9_3=l9_2;
l9_3.w=0.0;
vec2 param_12=inputTexDims.xy;
int param_13=inputTexLayout;
int param_14=inputTexGetStereoViewIndex();
vec2 param_15=clamp((((mat4(vec4(0.5,0.0,0.0,0.0),vec4(0.0,0.5,0.0,0.0),vec4(0.0),vec4(0.5,0.5,0.0,1.0))*sc_ModelViewProjectionMatrixArray[sc_GetStereoViewIndex()])*mat4(vec4(2.0,0.0,0.0,0.0),vec4(0.0,2.0,0.0,0.0),vec4(0.0),vec4(-1.0,-1.0,0.0,1.0)))*l9_3).xy+Globals.gScreenCoord,vec2(0.01),vec2(0.99));
bool param_16=(int(SC_USE_UV_TRANSFORM_inputTex)!=0);
mat3 param_17=inputTexTransform;
ivec2 param_18=g9_60;
bool param_19=(int(SC_USE_UV_MIN_MAX_inputTex)!=0);
vec4 param_20=inputTexUvMinMax;
bool param_21=(int(SC_USE_CLAMP_TO_BORDER_inputTex)!=0);
vec4 param_22=inputTexBorderColor;
float param_23=0.0;
vec4 l9_4=sc_SampleTextureBiasOrLevel(param_12,param_13,param_14,param_15,param_16,param_17,param_18,param_19,param_20,param_21,param_22,param_23,inputTex);
Default=l9_4.xyz;
Result=Default;
}
void Node32_If_else(float Bool1,vec3 Value1,inout vec3 Default,out vec3 Result,ssGlobals Globals)
{
vec2 param=colorTexDims.xy;
int param_1=colorTexLayout;
int param_2=colorTexGetStereoViewIndex();
vec2 param_3=Globals.Surface_UVCoord0;
bool param_4=(int(SC_USE_UV_TRANSFORM_colorTex)!=0);
mat3 param_5=colorTexTransform;
ivec2 param_6=g9_61;
bool param_7=(int(SC_USE_UV_MIN_MAX_colorTex)!=0);
vec4 param_8=colorTexUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_colorTex)!=0);
vec4 param_10=colorTexBorderColor;
float param_11=0.0;
vec4 l9_0=sc_SampleTextureBiasOrLevel(param,param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9,param_10,param_11,colorTex);
vec4 l9_1=((l9_0*(colorMax-colorMin))+colorMin)*vec4(textureintensity);
float l9_2=0.0;
vec3 l9_3=vec3(0.0);
vec3 l9_4=vec3(0.0);
ssGlobals l9_5=Globals;
vec3 l9_6;
Node94_If_else(l9_2,l9_3,l9_4,l9_6,l9_5);
Default=(vec3(1.0-l9_1.w)*l9_6)+l9_1.xyz;
Result=Default;
}
...
if (l9_0.x<l9_1.x)
{
l9_2=vec4(l9_1.xy,g9_75,l9_0.x);
}
else
{
l9_2=vec4(l9_0.x,l9_1.y,g9_75,l9_1.x);
}
...
if (l9_44.x<l9_46.x)
{
l9_47=vec4(l9_46.xy,g9_75,l9_44.x);
}
else
{
l9_47=vec4(l9_44.x,l9_46.y,g9_75,l9_46.x);
}
...
if (l9_55.x<l9_60.x)
{
l9_61=vec4(l9_60.xy,g9_75,l9_55.x);
}
else
{
l9_61=vec4(l9_55.x,l9_60.y,g9_75,l9_60.x);
}
...
if (l9_64.x<l9_69.x)
{
l9_70=vec4(l9_69.xy,g9_75,l9_64.x);
}
else
{
l9_70=vec4(l9_64.x,l9_69.y,g9_75,l9_69.x);
}
...
if (l9_74.x<l9_78.x)
{
l9_79=vec4(l9_78.xy,g9_75,l9_74.x);
}
else
{
l9_79=vec4(l9_74.x,l9_78.y,g9_75,l9_78.x);
}
...
vec4 l9_4=vec4(l9_3.x,l9_3.y,l9_3.z,g9_74.w);
l9_4.w=1.0;
result=l9_4;
}
#else
...
vec2 param=screenTexDims.xy;
int param_1=screenTexLayout;
int param_2=screenTexGetStereoViewIndex();
vec2 param_3=l9_3;
bool param_4=(int(SC_USE_UV_TRANSFORM_screenTex)!=0);
mat3 param_5=screenTexTransform;
ivec2 param_6=g9_62;
bool param_7=(int(SC_USE_UV_MIN_MAX_screenTex)!=0);
vec4 param_8=screenTexUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_screenTex)!=0);
vec4 param_10=screenTexBorderColor;
float param_11=0.0;
vec4 l9_4=sc_SampleTextureBiasOrLevel(param,param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9,param_10,param_11,screenTex);
float l9_5=0.0;
vec3 l9_6=vec3(0.0);
vec3 l9_7=vec3(0.0);
ssGlobals l9_8=ssGlobals(l9_1,l9_2,g9_70,l9_3,varPackedTex.xy);
vec3 l9_9;
Node32_If_else(l9_5,l9_6,l9_7,l9_9,l9_8);
vec4 l9_10=vec4(l9_9.x,l9_9.y,l9_9.z,vec4(0.0).w);
l9_10.w=1.0;
vec2 param_12=opacityTexDims.xy;
int param_13=opacityTexLayout;
int param_14=opacityTexGetStereoViewIndex();
vec2 param_15=varPackedTex.xy;
bool param_16=(int(SC_USE_UV_TRANSFORM_opacityTex)!=0);
mat3 param_17=opacityTexTransform;
ivec2 param_18=g9_63;
bool param_19=(int(SC_USE_UV_MIN_MAX_opacityTex)!=0);
vec4 param_20=opacityTexUvMinMax;
bool param_21=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
vec4 param_22=opacityTexBorderColor;
float param_23=0.0;
vec4 l9_11=sc_SampleTextureBiasOrLevel(param_12,param_13,param_14,param_15,param_16,param_17,param_18,param_19,param_20,param_21,param_22,param_23,opacityTex);
vec4 l9_12=mix(l9_4,mix(l9_4,l9_10,l9_11),vec4(overallintensity));
float l9_13=l9_12.w;
...
{
if (l9_13<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 param_24=l9_12;
vec4 l9_14=ngsPixelShader(param_24);
vec4 l9_15=max(l9_14,vec4(0.0));
vec4 param_25=l9_15;
sc_writeFragData0(param_25);
vec4 l9_16=clamp(l9_15,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_17=clamp(viewSpaceDepth()*0.001,0.0,1.0);
vec4 l9_18=vec4(max(0.0,1.00392-l9_17),min(1.0,l9_17+0.00392157),0.0,0.0);
