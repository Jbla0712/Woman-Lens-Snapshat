...
//sampler sampler opacityTexSmpSC 2:13
...
//texture texture2D opacityTex 2:2:2:13
...
#endif
const ivec2 g9_55=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex);
...
#endif
const ivec2 g9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex);
...
vec2 l9_0=baseTexDims.xy;
int l9_1=baseTexLayout;
int l9_2=baseTexGetStereoViewIndex();
vec2 l9_3=varPackedTex.xy;
bool l9_4=(int(SC_USE_UV_TRANSFORM_baseTex)!=0);
mat3 l9_5=baseTexTransform;
ivec2 l9_6=g9_55;
bool l9_7=(int(SC_USE_UV_MIN_MAX_baseTex)!=0);
vec4 l9_8=baseTexUvMinMax;
bool l9_9=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
vec4 l9_10=baseTexBorderColor;
float l9_11=0.0;
vec4 l9_12=sc_SampleTextureBiasOrLevel(l9_0,l9_1,l9_2,l9_3,l9_4,l9_5,l9_6,l9_7,l9_8,l9_9,l9_10,l9_11,baseTex);
vec4 l9_13=baseColor*l9_12;
vec2 l9_14=opacityTexDims.xy;
int l9_15=opacityTexLayout;
int l9_16=opacityTexGetStereoViewIndex();
vec2 l9_17=(varPackedTex.xy*uv2Scale)+uv2Offset;
bool l9_18=(int(SC_USE_UV_TRANSFORM_opacityTex)!=0);
mat3 l9_19=opacityTexTransform;
ivec2 l9_20=g9_56;
bool l9_21=(int(SC_USE_UV_MIN_MAX_opacityTex)!=0);
vec4 l9_22=opacityTexUvMinMax;
bool l9_23=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
vec4 l9_24=opacityTexBorderColor;
float l9_25=0.0;
vec4 l9_26=sc_SampleTextureBiasOrLevel(l9_14,l9_15,l9_16,l9_17,l9_18,l9_19,l9_20,l9_21,l9_22,l9_23,l9_24,l9_25,opacityTex);
float l9_27=l9_13.w*l9_26.x;
vec4 l9_28=vec4(l9_13.x,l9_13.y,l9_13.z,vec4(0.0).w);
l9_28.w=l9_27;
...
{
if (l9_27<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 param=l9_28;
vec4 l9_29=ngsPixelShader(param);
vec4 l9_30=max(l9_29,vec4(0.0));
vec4 param_1=l9_30;
sc_writeFragData0(param_1);
vec4 l9_31=clamp(l9_30,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_32=clamp(viewSpaceDepth()*0.001,0.0,1.0);
vec4 l9_33=vec4(max(0.0,1.00392-l9_32),min(1.0,l9_32+0.00392157),0.0,0.0);
