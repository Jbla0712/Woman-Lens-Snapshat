...
vec4 l9_4=vec4(l9_3.x,l9_3.y,l9_3.z,g9_65.w);
l9_4.w=1.0;
result=l9_4;
}
#else
...
float l9_1=l9_0.w-(1.0-baseColor.w);
vec4 l9_2=g9_66;
l9_2.x=baseColor.x;
vec4 l9_3=l9_2;
l9_3.y=baseColor.y;
...
{
if (l9_1<((mod(dot(floor(mod(sc_GetGlFragCoord().xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 param_12=l9_6;
vec4 l9_7=ngsPixelShader(param_12);
vec4 l9_8=max(l9_7,vec4(0.0));
vec4 param_13=l9_8;
sc_writeFragData0(param_13);
vec4 l9_9=clamp(l9_8,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_10=clamp(viewSpaceDepth()*0.001,0.0,1.0);
vec4 l9_11=vec4(max(0.0,1.00392-l9_10),min(1.0,l9_10+0.00392157),0.0,0.0);
