...
float l9_2=l9_1.w-(1.0-baseColor.w);
vec4 l9_3=vec4(0.0);
l9_3.x=baseColor.x;
vec4 l9_4=l9_3;
l9_4.y=baseColor.y;
...
{
if (l9_2<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
#endif
vec4 l9_8=ngsPixelShader(l9_7);
vec4 l9_9=max(l9_8,vec4(0.0));
sc_writeFragData0(l9_9);
vec4 l9_10=clamp(l9_9,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_11=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_11),min(1.0,l9_11+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_12=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_12).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_13=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_12).xy);
float l9_14=packValue(l9_13);
vec4 l9_15=vec4(0.0);
l9_15.x=l9_14;
vec4 l9_17=l9_15;
l9_17.y=packValue(l9_13);
vec4 l9_19=l9_17;
l9_19.z=packValue(l9_13);
vec4 l9_21=l9_19;
l9_21.w=packValue(l9_13);
vec4 l9_23=vec4(0.0);
l9_23.x=packValue(l9_13);
vec4 l9_25=l9_23;
l9_25.y=packValue(l9_13);
vec4 l9_27=l9_25;
l9_27.z=packValue(l9_13);
vec4 l9_28=l9_27;
l9_28.w=packValue(l9_13);
int l9_29=int(l9_10.w*255.0);
float l9_30=packValue(l9_29);
vec4 l9_31=vec4(0.0);
l9_31.x=l9_30;
vec4 l9_33=l9_31;
l9_33.y=packValue(l9_29);
vec4 l9_35=l9_33;
l9_35.z=packValue(l9_29);
vec4 l9_36=l9_35;
l9_36.w=packValue(l9_29);
sc_writeFragData0(l9_28);
sc_writeFragData1(l9_21);
sc_writeFragData2(l9_36);
...
if (l9_48==0)
{
l9_51=texture2D(sc_OITAlpha0,l9_37);
l9_50=texture2D(sc_OITDepthLow0,l9_37);
l9_49=texture2D(sc_OITDepthHigh0,l9_37);
}
else
{
l9_51=l9_44;
...
if (l9_48==1)
{
l9_47=texture2D(sc_OITAlpha1,l9_37);
l9_46=texture2D(sc_OITDepthLow1,l9_37);
l9_45=texture2D(sc_OITDepthHigh1,l9_37);
}
else
{
l9_47=l9_51;
...
if (any(notEqual(l9_45,vec4(0.0)))||any(notEqual(l9_46,vec4(0.0))))
{
int l9_52[8];
l9_52[0]=l9_38[0];
l9_52[1]=l9_38[1];
...
l9_52[6]=l9_38[6];
l9_52[7]=l9_38[7];
unpackValues(l9_45.w,l9_48,l9_52);
unpackValues(l9_45.z,l9_48,l9_52);
unpackValues(l9_45.y,l9_48,l9_52);
unpackValues(l9_45.x,l9_48,l9_52);
unpackValues(l9_46.w,l9_48,l9_52);
unpackValues(l9_46.z,l9_48,l9_52);
unpackValues(l9_46.y,l9_48,l9_52);
unpackValues(l9_46.x,l9_48,l9_52);
int l9_61[8];
l9_61[0]=l9_39[0];
l9_61[1]=l9_39[1];
l9_61[2]=l9_39[2];
...
l9_61[6]=l9_39[6];
l9_61[7]=l9_39[7];
unpackValues(l9_47.w,l9_48,l9_61);
unpackValues(l9_47.z,l9_48,l9_61);
unpackValues(l9_47.y,l9_48,l9_61);
unpackValues(l9_47.x,l9_48,l9_61);
}
l9_44=l9_47;
l9_43=l9_46;
l9_42=l9_45;
...
mediump vec4 l9_66=texture2D(sc_OITFilteredDepthBoundsTexture,l9_37);
vec2 l9_67=l9_66.xy;
int l9_68;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_68=encodeDepth(((1.0-l9_66.x)*1000.0)+l9_69,l9_67);
}
#else
{
l9_68=0;
...
#endif
int l9_70=encodeDepth(viewSpaceDepth(),l9_67);
vec4 l9_71;
l9_71=l9_10*l9_10.w;
vec4 l9_72;
int l9_73=0;
...
if (l9_73<8)
{
int l9_74=l9_38[l9_73];
int l9_75=l9_70-l9_68;
...
if (l9_77)
{
vec3 l9_78=l9_71.xyz*(1.0-(float(l9_39[l9_73])*0.00392157));
