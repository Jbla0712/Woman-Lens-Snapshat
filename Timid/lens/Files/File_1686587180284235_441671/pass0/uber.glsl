...
//sampler sampler baseTexSmpSC 2:15
...
//texture texture2D baseTex 2:0:2:15
//texture texture2D intensityTexture 2:1:2:16
//texture texture2D sc_OITAlpha0 2:4:2:19
//texture texture2D sc_OITAlpha1 2:5:2:19
//texture texture2D sc_OITDepthHigh0 2:6:2:19
//texture texture2D sc_OITDepthHigh1 2:7:2:19
//texture texture2D sc_OITDepthLow0 2:8:2:19
//texture texture2D sc_OITDepthLow1 2:9:2:19
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:10:2:19
//texture texture2D sc_OITFrontDepthTexture 2:11:2:19
...
vec3 l9_2=mix(l9_1.xyz,vec3(0.0),vec3(0.390005));
float l9_3=l9_1.w;
...
{
if (l9_3<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
#if (sc_OITDepthBoundsPass)
{
float l9_8=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_8),min(1.0,l9_8+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_9=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_9).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_10=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_9).xy);
float l9_11=packValue(l9_10);
vec4 l9_12=vec4(0.0);
l9_12.x=l9_11;
vec4 l9_14=l9_12;
l9_14.y=packValue(l9_10);
vec4 l9_16=l9_14;
l9_16.z=packValue(l9_10);
vec4 l9_18=l9_16;
l9_18.w=packValue(l9_10);
vec4 l9_20=vec4(0.0);
l9_20.x=packValue(l9_10);
vec4 l9_22=l9_20;
l9_22.y=packValue(l9_10);
vec4 l9_24=l9_22;
l9_24.z=packValue(l9_10);
vec4 l9_25=l9_24;
l9_25.w=packValue(l9_10);
int l9_26=int(l9_7.w*255.0);
float l9_27=packValue(l9_26);
vec4 l9_28=vec4(0.0);
l9_28.x=l9_27;
vec4 l9_30=l9_28;
l9_30.y=packValue(l9_26);
vec4 l9_32=l9_30;
l9_32.z=packValue(l9_26);
vec4 l9_33=l9_32;
l9_33.w=packValue(l9_26);
sc_writeFragData0(l9_25);
sc_writeFragData1(l9_18);
...
if (l9_45==0)
{
l9_48=texture2D(sc_OITAlpha0,l9_34);
l9_47=texture2D(sc_OITDepthLow0,l9_34);
l9_46=texture2D(sc_OITDepthHigh0,l9_34);
}
else
{
l9_48=l9_41;
...
if (l9_45==1)
{
l9_44=texture2D(sc_OITAlpha1,l9_34);
l9_43=texture2D(sc_OITDepthLow1,l9_34);
l9_42=texture2D(sc_OITDepthHigh1,l9_34);
}
else
{
l9_44=l9_48;
...
if (any(notEqual(l9_42,vec4(0.0)))||any(notEqual(l9_43,vec4(0.0))))
{
int l9_49[8];
l9_49[0]=l9_35[0];
l9_49[1]=l9_35[1];
...
l9_49[6]=l9_35[6];
l9_49[7]=l9_35[7];
unpackValues(l9_42.w,l9_45,l9_49);
unpackValues(l9_42.z,l9_45,l9_49);
unpackValues(l9_42.y,l9_45,l9_49);
unpackValues(l9_42.x,l9_45,l9_49);
unpackValues(l9_43.w,l9_45,l9_49);
unpackValues(l9_43.z,l9_45,l9_49);
unpackValues(l9_43.y,l9_45,l9_49);
unpackValues(l9_43.x,l9_45,l9_49);
int l9_58[8];
l9_58[0]=l9_36[0];
l9_58[1]=l9_36[1];
l9_58[2]=l9_36[2];
...
l9_58[6]=l9_36[6];
l9_58[7]=l9_36[7];
unpackValues(l9_44.w,l9_45,l9_58);
unpackValues(l9_44.z,l9_45,l9_58);
unpackValues(l9_44.y,l9_45,l9_58);
unpackValues(l9_44.x,l9_45,l9_58);
}
l9_41=l9_44;
l9_40=l9_43;
l9_39=l9_42;
...
mediump vec4 l9_63=texture2D(sc_OITFilteredDepthBoundsTexture,l9_34);
vec2 l9_64=l9_63.xy;
int l9_65;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_65=encodeDepth(((1.0-l9_63.x)*1000.0)+l9_66,l9_64);
}
#else
{
l9_65=0;
...
#endif
int l9_67=encodeDepth(viewSpaceDepth(),l9_64);
vec4 l9_68;
l9_68=l9_7*l9_7.w;
vec4 l9_69;
int l9_70=0;
...
if (l9_70<8)
{
int l9_71=l9_35[l9_70];
int l9_72=l9_67-l9_65;
bool l9_73=l9_71<l9_72;
bool l9_74;
if (l9_73)
{
l9_74=l9_35[l9_70]>0;
...
if (l9_74)
{
vec3 l9_75=l9_68.xyz*(1.0-(float(l9_36[l9_70])*0.00392157));
l9_69=vec4(l9_75.x,l9_75.y,l9_75.z,l9_68.w);
}
else
{
l9_69=l9_68;
