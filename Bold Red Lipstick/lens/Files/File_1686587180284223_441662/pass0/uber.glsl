...
#endif
vec4 l9_5=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_4,(varPackedTex.xy*uv2Scale)+uv2Offset,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex);
float l9_6=l9_3.w*l9_5.x;
vec4 l9_7=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_7.w=l9_6;
#if (sc_BlendMode_AlphaTest)
{
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_12=sc_ScreenCoordsGlobalToView(l9_0);
