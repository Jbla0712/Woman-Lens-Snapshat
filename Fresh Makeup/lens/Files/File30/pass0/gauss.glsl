...
void main()
{
	...
	blurCoordinates[1]=coordsTex+vec2(1.444444*sc_ScreenTextureSize[2],0.0);
	blurCoordinates[2]=coordsTex -vec2(1.444444*sc_ScreenTextureSize[2],0.0);
	blurCoordinates[3]=coordsTex+vec2(3.357143*sc_ScreenTextureSize[2],0.0);
	blurCoordinates[4]=coordsTex -vec2(3.357143*sc_ScreenTextureSize[2],0.0);
}
