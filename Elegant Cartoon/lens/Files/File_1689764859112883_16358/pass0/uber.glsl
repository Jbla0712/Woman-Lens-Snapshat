...
//sampler sampler colorTexSmpSC 2:22
//sampler sampler inputTexSmpSC 2:23
...
//sampler sampler screenTexSmpSC 2:32
//sampler sampler texWarpSmpSC 2:34
//texture texture2D colorTex 2:1:2:22
//texture texture2D inputTex 2:2:2:23
//texture texture2D intensityTexture 2:3:2:24
//texture texture2D opacityTex 2:4:2:25
//texture texture2D sc_OITAlpha0 2:7:2:28
//texture texture2D sc_OITAlpha1 2:8:2:28
//texture texture2D sc_OITDepthHigh0 2:9:2:28
//texture texture2D sc_OITDepthHigh1 2:10:2:28
//texture texture2D sc_OITDepthLow0 2:11:2:28
//texture texture2D sc_OITDepthLow1 2:12:2:28
//texture texture2D sc_OITFilteredDepthBoundsTexture 2:13:2:28
//texture texture2D sc_OITFrontDepthTexture 2:14:2:28
//texture texture2D sc_ScreenTexture 2:15:2:29
//texture texture2D screenTex 2:18:2:32
//texture texture2D texWarp 2:19:2:34
//SG_REFLECTION_END
...
vec3 l9_44=normalize(varTangent.xyz);
varTangent=vec4(l9_44.x,l9_44.y,l9_44.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_45=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
vec4 l9_46;
#if (sc_RenderingSpace==2)
{
l9_46=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
vec4 l9_47;
#if (sc_RenderingSpace==1)
{
l9_47=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_21;
}
#else
{
l9_47=l9_21;
...
#if (sc_RenderingSpace==4)
{
l9_49=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_21)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_50;
...
#endif
varPackedTex=vec4(l9_7,l9_6);
#if (sc_ProjectiveShadowsReceiver)
{
vec4 l9_52;
#if (sc_RenderingSpace==1)
{
l9_52=sc_ModelMatrix*l9_21;
}
#else
{
l9_52=l9_21;
...
#endif
vec4 l9_53=sc_ProjectorMatrix*l9_52;
varShadowTex=((l9_53.xy/vec2(l9_53.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_54;
...
{
vec4 l9_55=l9_48;
l9_55.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_48.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_48.w;
l9_54=l9_55;
}
#else
{
...
{
float l9_56=dot(l9_54,sc_StereoClipPlanes[sc_StereoViewID]);
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_15=sc_readFragData0_Platform();
vec4 l9_16;
...
#endif
vec4 l9_5=sc_SampleTextureBiasOrLevel(colorTexDims.xy,colorTexLayout,l9_4,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_colorTex)!=0),colorTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_colorTex,SC_SOFTWARE_WRAP_MODE_V_colorTex),(int(SC_USE_UV_MIN_MAX_colorTex)!=0),colorTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_colorTex)!=0),colorTexBorderColor,0.0,colorTex);
vec4 l9_6=((l9_5*(colorMax-colorMin))+colorMin)*vec4(textureintensity);
int l9_7;
...
#endif
vec4 l9_8=(((sc_SampleTextureBiasOrLevel(texWarpDims.xy,texWarpLayout,l9_7,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_texWarp)!=0),texWarpTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_texWarp,SC_SOFTWARE_WRAP_MODE_V_texWarp),(int(SC_USE_UV_MIN_MAX_texWarp)!=0),texWarpUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_texWarp)!=0),texWarpBorderColor,0.0,texWarp)*(warpMax-warpMin))+warpMin)*vec4(1.0,-1.0,1.0,1.0))*vec4(warp_intensity);
vec4 l9_9=vec4(l9_8.x,l9_8.y,vec4(0.0).z,vec4(0.0).w);
l9_9.z=0.0;
vec4 l9_10=l9_9;
l9_10.w=0.0;
int l9_11;
...
#endif
vec3 l9_12=(vec3(1.0-l9_6.w)*sc_SampleTextureBiasOrLevel(inputTexDims.xy,inputTexLayout,l9_11,clamp((((mat4(vec4(0.5,0.0,0.0,0.0),vec4(0.0,0.5,0.0,0.0),vec4(0.0),vec4(0.5,0.5,0.0,1.0))*sc_ModelViewProjectionMatrixArray[sc_GetStereoViewIndex()])*mat4(vec4(2.0,0.0,0.0,0.0),vec4(0.0,2.0,0.0,0.0),vec4(0.0),vec4(-1.0,-1.0,0.0,1.0)))*l9_10).xy+l9_1,vec2(0.01),vec2(0.99)),(int(SC_USE_UV_TRANSFORM_inputTex)!=0),inputTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_inputTex,SC_SOFTWARE_WRAP_MODE_V_inputTex),(int(SC_USE_UV_MIN_MAX_inputTex)!=0),inputTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_inputTex)!=0),inputTexBorderColor,0.0,inputTex).xyz)+l9_6.xyz;
...
{
if (l9_17<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)*0.0588235))
{
discard;
}
}
...
#if (sc_OITDepthBoundsPass)
{
float l9_21=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_21),min(1.0,l9_21+0.00392157),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_22).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_23=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_22).xy);
float l9_24=packValue(l9_23);
vec4 l9_25=vec4(0.0);
l9_25.x=l9_24;
vec4 l9_27=l9_25;
l9_27.y=packValue(l9_23);
vec4 l9_29=l9_27;
l9_29.z=packValue(l9_23);
vec4 l9_31=l9_29;
l9_31.w=packValue(l9_23);
vec4 l9_33=vec4(0.0);
l9_33.x=packValue(l9_23);
vec4 l9_35=l9_33;
l9_35.y=packValue(l9_23);
vec4 l9_37=l9_35;
l9_37.z=packValue(l9_23);
vec4 l9_38=l9_37;
l9_38.w=packValue(l9_23);
int l9_39=int(l9_20.w*255.0);
float l9_40=packValue(l9_39);
vec4 l9_41=vec4(0.0);
l9_41.x=l9_40;
vec4 l9_43=l9_41;
l9_43.y=packValue(l9_39);
vec4 l9_45=l9_43;
l9_45.z=packValue(l9_39);
vec4 l9_46=l9_45;
l9_46.w=packValue(l9_39);
sc_writeFragData0(l9_38);
sc_writeFragData1(l9_31);
sc_writeFragData2(l9_46);
...
if (l9_58==0)
{
l9_61=texture2D(sc_OITAlpha0,l9_47);
l9_60=texture2D(sc_OITDepthLow0,l9_47);
l9_59=texture2D(sc_OITDepthHigh0,l9_47);
}
else
{
l9_61=l9_54;
...
if (l9_58==1)
{
l9_57=texture2D(sc_OITAlpha1,l9_47);
l9_56=texture2D(sc_OITDepthLow1,l9_47);
l9_55=texture2D(sc_OITDepthHigh1,l9_47);
}
else
{
l9_57=l9_61;
...
l9_62[6]=l9_48[6];
l9_62[7]=l9_48[7];
unpackValues(l9_55.w,l9_58,l9_62);
unpackValues(l9_55.z,l9_58,l9_62);
unpackValues(l9_55.y,l9_58,l9_62);
unpackValues(l9_55.x,l9_58,l9_62);
unpackValues(l9_56.w,l9_58,l9_62);
unpackValues(l9_56.z,l9_58,l9_62);
unpackValues(l9_56.y,l9_58,l9_62);
unpackValues(l9_56.x,l9_58,l9_62);
int l9_71[8];
l9_71[0]=l9_49[0];
l9_71[1]=l9_49[1];
l9_71[2]=l9_49[2];
...
l9_71[6]=l9_49[6];
l9_71[7]=l9_49[7];
unpackValues(l9_57.w,l9_58,l9_71);
unpackValues(l9_57.z,l9_58,l9_71);
unpackValues(l9_57.y,l9_58,l9_71);
unpackValues(l9_57.x,l9_58,l9_71);
}
l9_54=l9_57;
l9_53=l9_56;
l9_52=l9_55;
...
mediump vec4 l9_76=texture2D(sc_OITFilteredDepthBoundsTexture,l9_47);
vec2 l9_77=l9_76.xy;
int l9_78;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_78=encodeDepth(((1.0-l9_76.x)*1000.0)+l9_79,l9_77);
}
#else
{
l9_78=0;
...
#endif
int l9_80=encodeDepth(viewSpaceDepth(),l9_77);
vec4 l9_81;
l9_81=l9_20*l9_20.w;
vec4 l9_82;
int l9_83=0;
...
if (l9_83<8)
{
int l9_84=l9_48[l9_83];
int l9_85=l9_80-l9_78;
...
if (l9_87)
{
vec3 l9_88=l9_81.xyz*(1.0-(float(l9_49[l9_83])*0.00392157));
